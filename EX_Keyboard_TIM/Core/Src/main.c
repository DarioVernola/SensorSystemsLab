...
int main(void)
{
  ...
  int min_duration = 2; //customizable parameter
  ...
  while (1)
  {
	 ...
	 {
		 if(pressedButtons[counter] > min_duration) //if you press the button for more than 50*2 milliseconds it will be considered
		 {
			 if(!ack[counter])
			 {
